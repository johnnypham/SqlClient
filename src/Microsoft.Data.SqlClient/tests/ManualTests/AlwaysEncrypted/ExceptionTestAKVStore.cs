...
namespace Microsoft.Data.SqlClient.ManualTesting.Tests.AlwaysEncrypted
{
    ...
    {
        private const KeyEncryptionKeyAlgorithm MasterKeyEncAlgo = KeyEncryptionKeyAlgorithm.RSA_OAEP;
        private const KeyEncryptionKeyAlgorithm BadMasterKeyEncAlgo = (KeyEncryptionKeyAlgorithm)1;
        ...
        public ExceptionTestAKVStore(SQLSetupStrategyAzureKeyVault fixture)
        {
            ...
            encryptedCek = fixture.AkvStoreProvider.WrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, cek);
        ...
        {
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, BadMasterKeyEncAlgo, cek));
            ...
            Exception ex2 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.WrapKey(DataTestUtility.AKVUrl, BadMasterKeyEncAlgo, cek));
        ...
        //{
        //    Exception ex1 = Assert.Throws<ArgumentNullException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, null, cek));
        //    Assert.Matches($@"Internal error. Key encryption algorithm cannot be null.\s+\(?Parameter (name: )?'?encryptionAlgorithm('\))?", ex1.Message);
        //    Exception ex2 = Assert.Throws<ArgumentNullException>(() => fixture.AkvStoreProvider.WrapKey(DataTestUtility.AKVUrl, null, cek));
        ...
        {
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.WrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, new byte[] { }));
        ...
        {
            Exception ex1 = Assert.Throws<ArgumentNullException>(() => fixture.AkvStoreProvider.WrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, null));
        ...
        {
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, new byte[] { }));
        ...
        {
            Exception ex1 = Assert.Throws<ArgumentNullException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, null));
        ...
        public void InvalidAlgorithmVersion()
        {
            ...
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, encrypteCekLocal));
        ...
        public void InvalidSignatureInEncryptedCek()
        {
            ...
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.UnwrapKey(DataTestUtility.AKVUrl, MasterKeyEncAlgo, encryptedCekLocal));
            Assert.Matches(errorMessage, ex1.Message);
        }
        ...
        public void InvalidURL()
        {
            ...
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.WrapKey(fakePath, MasterKeyEncAlgo, cek));
            Assert.Matches(errorMessage, ex1.Message);

            Exception ex2 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.UnwrapKey(fakePath, MasterKeyEncAlgo, encryptedCek));
        ...
        public void NullAKVKeyPath()
        {
            Exception ex1 = Assert.Throws<ArgumentNullException>(
                () => fixture.AkvStoreProvider.WrapKey(null, MasterKeyEncAlgo, cek));
            ...
            Exception ex2 = Assert.Throws<ArgumentNullException>(
                () => fixture.AkvStoreProvider.UnwrapKey(null, MasterKeyEncAlgo, encryptedCek));
        ...
        public void InvalidCertificatePath()
        {
            ...
            Exception ex1 = Assert.Throws<ArgumentException>(() => fixture.AkvStoreProvider.WrapKey(dummyPath, MasterKeyEncAlgo, cek));
            Assert.Matches(errorMessage, ex1.Message);

            Exception ex2 = Assert.Throws<ArgumentException>(
                () => fixture.AkvStoreProvider.UnwrapKey(dummyPath, MasterKeyEncAlgo, encryptedCek));
            Assert.Matches(errorMessage, ex2.Message);
        }
        ...
        {
            //sign the cmk
            byte[] cmkSignature = fixture.AkvStoreProvider.Sign(DataTestUtility.AKVUrl, allowEnclaveComputations: fEnclaveEnabled);
            Assert.True(cmkSignature != null);

            // Expect failed verification for a toggle of enclaveEnabled bit
            if (fixture.AkvStoreProvider.Verify(DataTestUtility.AKVUrl, allowEnclaveComputations: !fEnclaveEnabled, signature: cmkSignature))
            {
            ...
            for (int i = 0; i < 10; i++)
            {
                Assert.True(fixture.AkvStoreProvider.Verify(DataTestUtility.AKVUrl, allowEnclaveComputations: fEnclaveEnabled, signature: tamperedCmkSignature), @"tamperedCmkSignature before tampering should be verified without any problems.");
                ...
                if (fixture.AkvStoreProvider.Verify(DataTestUtility.AKVUrl, allowEnclaveComputations: fEnclaveEnabled, signature: tamperedCmkSignature))
                {
                    Exception ex1 = Assert.Throws<ArgumentException>(() => { });
                    Assert.Contains(@"Unable to verify Column Master Key signature using key store provider", ex1.Message);
                }
