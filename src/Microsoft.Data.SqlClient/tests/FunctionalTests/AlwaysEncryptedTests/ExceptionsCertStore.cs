...
namespace Microsoft.Data.SqlClient.Tests.AlwaysEncryptedTests
{
    ...
    {
        private readonly KeyEncryptionKeyAlgorithm encryptionAlgorithm = KeyEncryptionKeyAlgorithm.RSA_OAEP;
        ...
        public void EmptyCertificateThumbprint()
        {
            ...
            ArgumentException e = Assert.Throws<ArgumentException>(() => ExceptionCertFixture.certStoreProvider.WrapKey(dummyPath, encryptionAlgorithm, ExceptionCertFixture.encryptedCek));
            ...
            e = Assert.Throws<ArgumentException>(() => ExceptionCertFixture.certStoreProvider.UnwrapKey(dummyPath, encryptionAlgorithm, ExceptionCertFixture.encryptedCek));
            Assert.Matches(expectedMessage, e.Message);
        }
        ...
        public void CertificateWithNoPrivateKey()
        {
            ...
            ArgumentException e = Assert.Throws<ArgumentException>(() => 
                ExceptionCertFixture.certStoreProvider.EncryptEncryptionKey(
                ExceptionCertFixture.masterKeyPathNPK, encryptionAlgorithm, ExceptionCertFixture.encryptedCek));
            ...
            e = Assert.Throws<ArgumentException>(() => 
                ExceptionCertFixture.certStoreProvider.DecryptEncryptionKey(
                ExceptionCertFixture.masterKeyPathNPK, encryptionAlgorithm, ExceptionCertFixture.encryptedCek));
            Assert.Contains(expectedMessage, e.Message);
        }
#endif
    ...
    public class ExceptionCertFixture : IDisposable
    {
        ...
        public ExceptionCertFixture()
        {
            ...
            encryptedCek = certStoreProvider.WrapKey(certificatePath, KeyEncryptionKeyAlgorithm.RSA_OAEP, cek);
#if NET46
